...
void SetupServerArgs(ArgsManager& argsman, bool can_listen_ipc)
{
    ...
    argsman.AddArg("-tolerant", strprintf("Enable Bitcoin Tolerant conservative relay/mining policy profile (default: %u)", DEFAULT_TOLERANT), ArgsManager::ALLOW_ANY, OptionsCategory::OPTIONS);
